    ...
    public static void main(String[] args) {
        ...
        try {
         ...
         // Create movies table
            ...
            String createTheatersTable = "CREATE TABLE IF NOT EXISTS theaters ("
                    + "theater_id INT PRIMARY KEY, "
                    + "seat_count INT, "
                    + "is_available TINYINT(1), "
                    + "seat_rows INT, "
                    + "seat_columns INT)";
            stmt.executeUpdate(createTheatersTable);
            ...
            String createCustomersTable = "CREATE TABLE IF NOT EXISTS customers ("
                    ...
                    + "customer_emailaddress VARCHAR(255))";
         ...
         // Insert data into movies table
            ...
            String insertTheatersData = "INSERT INTO theaters (theater_id, seat_count, is_available, seat_rows, seat_columns) VALUES "
                    + "(1, 30, 1, 6, 5),"
                    + "(2, 12, 1, 4, 3),"
                    + "(3, 20, 1, 5, 4),"
                    + "(4, 25, 1, 5, 5),"
            ...
            System.out.println("DB connection or query execution error");
            e.printStackTrace();
        }
    }
}